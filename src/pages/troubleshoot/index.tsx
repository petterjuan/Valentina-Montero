...
// Define SystemStatus directly in the file as it's only used here
...
export default function TroubleshootPage() {
    ...
    const runChecks = React.useCallback(async () => {
      ...
      const [fetchedStatuses, fetchedLogs] = await Promise.all([
          fetch('/api/troubleshoot/status').then(res => res.json()),
          fetch('/api/troubleshoot/logs').then(res => res.json()),
      ]);
